...
const Update = () => {
  ...
  const handleUpdate = (event) => {
    ...
    fetch(`https://tour-spots-server-side-main.vercel.app/update/${_id}`, {
      method: "PUT",
      headers: {
  ...
  return (
    <div
      className="p-4 md:p-16 lg:p-24  bg-[#F4F3F0]
        rounded-lg"
    >
      <Fade direction="left">
        <h1 className="text-2xl md:text-4xl mx-auto  font-bold text-center mb-6 w-2/3 md:w-full dark:text-black">
          Update Tourists Spot Form
        </h1>
      </Fade>
      ...
      >
        ...
        <div className="col-span-1 md:col-span-2 ">
          <input
            ...
            className="w-full font-medium text-white text-lg md:text-xl md:pb-2 md:px-4 py-1 px-2 rounded-lg bg-primary text-center"
          />
        </div>
      </form>
    </div>
