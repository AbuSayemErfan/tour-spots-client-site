...
const ViewDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://tour-spots-server-side-main.vercel.app/views/${id}`)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        setDetails(data);
      ...
      <div className=" flex flex-col md:flex-row gap-6">
        ...
        <div className="border-primary  border-b-2  pt-6  md:border-l-2  md:border-b-0 md:pt-0   md:pl-6">
          <div className="font-bold text-xl flex gap-2 items-center mb-2">
            ...
            <span className="absolute top-0 hidden md:block md:right-0  bg-red-400 rounded-sm p-2 ">
              {country_Name}
            </span>
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2">
            <div className="flex gap-2 items-center  justify-start mb-2">
              ...
              <p className="text-gray-700  ">{`${tourists_spot_name}`}</p>
            </div>
